...
type ChatGroup struct {
	...
	ChatUserList []*ChatUser            `protobuf:"bytes,9,rep,name=chat_user_list,json=chatUserList,proto3" json:"chat_user_list,omitempty"`
}
...
type Chat struct {
	...
	From      int64                  `protobuf:"varint,3,opt,name=from,proto3" json:"from,omitempty"`                           // 誰からのメッセージか
	...
	GroupId   int64                  `protobuf:"varint,7,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`      // グループID
	Name      string                 `protobuf:"bytes,8,opt,name=name,proto3" json:"name,omitempty"`                            // ユーザー名
	UserId    []int64                `protobuf:"varint,9,rep,packed,name=user_id,json=userId,proto3" json:"user_id,omitempty"`  // ユーザーID
}
...
func (x *ChatUser) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *ChatUser) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
var file_chat_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xcb, 0x02, 0x0a, 0x09, 0x43, 0x68, 0x61, 0x74, 0x47, 0x72, 0x6f, 0x75,
	...
	0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x43, 0x68, 0x61,
	0x74, 0x52, 0x08, 0x63, 0x68, 0x61, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x34, 0x0a, 0x0e, 0x63,
	0x68, 0x61, 0x74, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20,
	...
	0x74, 0x22, 0x96, 0x02, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x6f, 0x6d, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20,
	...
	0x41, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x07,
	...
	0x65, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x03,
	0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xf7, 0x01, 0x0a, 0x08, 0x43,
	0x68, 0x61, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x31, 0x0a, 0x14,
	0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71,
	...
	0x42, 0x0a, 0x10, 0x43, 0x68, 0x61, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x0a, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x43,
	0x68, 0x61, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x09, 0x63, 0x68, 0x61, 0x74, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x22, 0x59, 0x0a, 0x11, 0x43, 0x68, 0x61, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70,
	...
	,
	...
	,
	...
	0x32, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x42, 0x79, 0x49, 0x64, 0x12, 0x13, 0x2e, 0x63, 0x68, 0x61,
	...
	0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x12, 0x1a, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x74, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x63,
...
var file_chat_proto_depIdxs = []int32{
	11, // 0: chat.ChatGroup.created_at:type_name -> google.protobuf.Timestamp
	11, // 1: chat.ChatGroup.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 2: chat.ChatGroup.chat_list:type_name -> chat.Chat
	2,  // 3: chat.ChatGroup.chat_user_list:type_name -> chat.ChatUser
	11, // 4: chat.Chat.created_at:type_name -> google.protobuf.Timestamp
	11, // 5: chat.Chat.updated_at:type_name -> google.protobuf.Timestamp
	11, // 6: chat.ChatUser.created_at:type_name -> google.protobuf.Timestamp
	11, // 7: chat.ChatUser.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 8: chat.ChatRequest.chat:type_name -> chat.Chat
	1,  // 9: chat.ChatResponse.chat:type_name -> chat.Chat
	0,  // 10: chat.ChatGroupRequest.chat_group:type_name -> chat.ChatGroup
	0,  // 11: chat.ChatGroupResponse.chat_group:type_name -> chat.ChatGroup
	0,  // 12: chat.ChatGroupListResponse.chat_group_list:type_name -> chat.ChatGroup
	0,  // 13: chat.ChatGroupService.Create:input_type -> chat.ChatGroup
	0,  // 14: chat.ChatGroupService.Update:input_type -> chat.ChatGroup
	4,  // 15: chat.ChatGroupService.Delete:input_type -> chat.ChatIdRequest
	4,  // 16: chat.ChatGroupService.GetById:input_type -> chat.ChatIdRequest
	4,  // 17: chat.ChatGroupService.GetByUserId:input_type -> chat.ChatIdRequest
	1,  // 18: chat.ChatService.Create:input_type -> chat.Chat
	1,  // 19: chat.ChatService.Update:input_type -> chat.Chat
	4,  // 20: chat.ChatService.Delete:input_type -> chat.ChatIdRequest
	4,  // 21: chat.ChatService.GetById:input_type -> chat.ChatIdRequest
	7,  // 22: chat.ChatService.GetStream:input_type -> chat.GetChatStreamRequest
	9,  // 23: chat.ChatGroupService.Create:output_type -> chat.ChatGroupResponse
	9,  // 24: chat.ChatGroupService.Update:output_type -> chat.ChatGroupResponse
	6,  // 25: chat.ChatGroupService.Delete:output_type -> chat.ChatBoolResponse
	9,  // 26: chat.ChatGroupService.GetById:output_type -> chat.ChatGroupResponse
	10, // 27: chat.ChatGroupService.GetByUserId:output_type -> chat.ChatGroupListResponse
	5,  // 28: chat.ChatService.Create:output_type -> chat.ChatResponse
	5,  // 29: chat.ChatService.Update:output_type -> chat.ChatResponse
	6,  // 30: chat.ChatService.Delete:output_type -> chat.ChatBoolResponse
	5,  // 31: chat.ChatService.GetById:output_type -> chat.ChatResponse
	5,  // 32: chat.ChatService.GetStream:output_type -> chat.ChatResponse
